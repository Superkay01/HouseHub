    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6 pt-10 sm:pt-14">
      ...
      <div class="text-center mb-12 sm:mb-16">
        ...
        <p class="max-w-2xl mx-auto text-sm sm:text-base md:text-lg text-[var(--steel-blue)]">
          Get answers quickly or reach out to the LodgeNext support team. We're available Monday - Saturday.
        </p>
      </div>
        ...
        <div class="space-y-5">
          ...
          <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow">
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="text-lg font-semibold text-[var(--royal-blue)]">Ilorin Support</h2>
            </div>
            <div class="space-y-2">
              <a href="tel:09030031328"
                ...
                <div>
                  ...
                  <p class="text-sm text-[var(--steel-blue)]">0903 003 1328</p>
                </div>
              </a>
              <a href="https://wa.me/2349030031328" target="_blank" rel="noopener noreferrer"
                ...
                <div>
                  ...
                  <p class="text-sm text-[var(--steel-blue)]">Chat with Ilorin support</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow">
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="text-lg font-semibold text-[var(--royal-blue)]">Ijebu Ode Support</h2>
            </div>
            <div class="space-y-2">
              <a href="tel:07059537201"
                 class="flex items-center gap-3 p-3 rounded-2xl hover:bg-gray-50 transition cursor-pointer group">
                <div class="w-9 h-9 rounded-xl bg-gray-50 group-hover:bg-[#ebf8ff] flex items-center justify-center text-[#0025cc] transition">
                  <Phone class="w-4 h-4" />
                </div>
                <div>
                  <p class="text-sm font-medium text-[var(--royal-blue)]">Phone</p>
                  <p class="text-sm text-[var(--steel-blue)]">0705 953 7201</p>
                </div>
              </a>
              <a href="https://wa.me/2347059537201" target="_blank" rel="noopener noreferrer"
                 class="flex items-center gap-3 p-3 rounded-2xl hover:bg-gray-50 transition cursor-pointer group">
                <div class="w-9 h-9 rounded-xl bg-gray-50 group-hover:bg-[#ebf8ff] flex items-center justify-center text-[#0025cc] transition">
                  <MessageCircle class="w-4 h-4" />
                </div>
                <div>
                  <p class="text-sm font-medium text-[var(--royal-blue)]">WhatsApp</p>
                  <p class="text-sm text-[var(--steel-blue)]">Chat with Ijebu Ode support</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow">
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="text-lg font-semibold text-[var(--royal-blue)]">Email Support</h2>
            </div>
            <div class="space-y-2">
              <a href="mailto:adegbesanoluwakayode52@gmail.com"
                 class="flex items-start gap-3 p-3 rounded-2xl hover:bg-gray-50 transition cursor-pointer group">
                <div class="w-9 h-9 rounded-xl bg-gray-50 group-hover:bg-[#ebf8ff] flex items-center justify-center text-[#0025cc] transition flex-shrink-0">
                  <Mail class="w-4 h-4" />
                </div>
                <div class="min-w-0">
                  <p class="text-sm font-medium text-[var(--royal-blue)]">Primary</p>
                  <p class="text-sm text-[var(--steel-blue)] break-all">adegbesanoluwakayode52@gmail.com</p>
                </div>
              </a>
              <a href="mailto:adegbesansamuel9@gmail.com"
                 class="flex items-start gap-3 p-3 rounded-2xl hover:bg-gray-50 transition cursor-pointer group">
                <div class="w-9 h-9 rounded-xl bg-gray-50 group-hover:bg-[#ebf8ff] flex items-center justify-center text-[#0025cc] transition flex-shrink-0">
                  <Mail class="w-4 h-4" />
                </div>
                <div class="min-w-0">
                  <p class="text-sm font-medium text-[var(--royal-blue)]">Secondary</p>
                  <p class="text-sm text-[var(--steel-blue)] break-all">adegbesansamuel9@gmail.com</p>
                </div>
              </a>
            </div>
          </div>
...
const faqs = [
  {
    q: 'How do I request a property inspection?',
    a: 'Open a property listing, click Request Inspection, choose your preferred date and time, pay the inspection fee if required, then submit.',
  },
  {
    q: 'How long does it take to confirm an inspection?',
    a: 'Once your request is submitted, an agent reviews it. You will receive a notification when it is accepted, scheduled, or updated.',
  },
  {
    q: 'Can I cancel or reschedule an inspection?',
    a: 'Yes. Go to My Requests or My Inspections and open the item to cancel or respond to a reschedule proposal, depending on the current status.',
  },
  {
    q: 'Where can I see my payments?',
    a: 'Go to Activity History to view your requests, inspections, and payment records in one place.',
  },
  {
    q: 'I paid but my request is still pending',
    a: 'Payment confirmation can take a short time. Refresh the page or check Activity History. If it remains pending, contact support with your payment reference.',
  },
  {
    q: 'I am not receiving notifications',
    a: 'Open Settings and ensure notification sound and preferences are enabled. Also confirm you are logged in with a stable internet connection.',
  },
]
...
const submitSupport = async () => {
  ...
  try {
    const { error } = await supabase.from('support_tickets').insert({
      ...
      subject: `[${form.value.location}] ${form.value.subject.trim()}`,
    ...
    form.value = { category: '', location: '', subject: '', message: '' }
